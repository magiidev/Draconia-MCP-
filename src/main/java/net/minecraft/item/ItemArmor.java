...
public class ItemArmor extends Item
{
    ...
    public static enum ArmorMaterial
    {
        ...
        OXYTE(Constants.NAME.toLowerCase() + ":" + "oxyte", 42, new int[]{3, 9, 7, 3}, 4),
        BAUXITE(Constants.NAME.toLowerCase() + ":" + "bauxite", 39, new int[]{4, 8, 7, 4}, 5),
        KOBALTE(Constants.NAME.toLowerCase() + ":" + "kobalte", 37, new int[]{3, 8, 6, 4}, 6),
        DOLOMITE(Constants.NAME.toLowerCase() + ":" + "dolomite", 35, new int[]{3, 8, 6, 4}, 8);
