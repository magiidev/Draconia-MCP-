...
public class Item
{
    ...
    /*--------------Arifureta------------*/
    //private ArifuretaTab arifuretaTabToDisplayOn;
    /*-----------------------------------*/
    ...
    public static Item getByNameOrIdCustom(String id)
    {
        Item item = (Item)itemRegistry.getObject(new ResourceLocation(Constants.NAME.toLowerCase(), id));
    ...
    /*-------------------------Arifureta------------------------------
    public void getSubItemsArifureta(Item itemIn, ArifuretaTab tab, List<ItemStack> subItems)
    {
        subItems.add(new ItemStack(itemIn, 1, 0));
    }

    public ArifuretaTab getArifuretaTab()
    {
        return this.arifuretaTabToDisplayOn;
    }

    public Item setArifuretaTab(ArifuretaTab tab)
    {
        this.arifuretaTabToDisplayOn = tab;
        return this;
    }
    ----------------------------------------------------------------*/
    ...
    public static void registerCustomItem(int id, String textualID, Item itemIn)
    {
        registerItem(id, new ResourceLocation(Constants.NAME.toLowerCase(), textualID), itemIn);
    }
    ...
    public static enum ToolMaterial
    {
        ...
        OXYTE(3, 3000, 12.0F, 6.0F, 5),
        BAUXITE(3, 2500, 10.5F, 4.5F, 7),
        KOBALTE(3, 2200, 10.0F, 4.0F, 8),
        DOLOMITE(3, 1900, 9.5F, 3.5F, 9);
        ...
        {
            return this == WOOD ? Item.getItemFromBlock(Blocks.planks) : (this == STONE ? Item.getItemFromBlock(Blocks.cobblestone) : (this == GOLD ? Items.gold_ingot : (this == IRON ? Items.iron_ingot : (this == EMERALD ? Items.diamond : (this == DOLOMITE ? ItemRegister.dolomite : (this == KOBALTE ? ItemRegister.kobalte : (this == BAUXITE ? ItemRegister.bauxite : (this == OXYTE ? ItemRegister.oxyte : null))))))));
        }
    }
}
