...
public class BiomeDecorator
{
    ...
    /*-----------Arifureta----------*/
    protected WorldGenerator oxyteGen;
    protected WorldGenerator bauxiteGen;
    protected WorldGenerator kobalteGen;
    protected WorldGenerator dolomiteGen;
    /*------------------------------*/
    ...
    public void decorate(World worldIn, Random random, BiomeGenBase biome, BlockPos p_180292_4_)
    {
        ...
        else
        {
            ...
            /*-----------Arifureta----------*/
            this.oxyteGen = new WorldGenMinable(BlockRegister.oxyte_ore.getDefaultState(), this.chunkProviderSettings.diamondSize);
            this.bauxiteGen = new WorldGenMinable(BlockRegister.bauxite_ore.getDefaultState(), this.chunkProviderSettings.diamondSize);
            this.kobalteGen = new WorldGenMinable(BlockRegister.kobalte_ore.getDefaultState(), this.chunkProviderSettings.diamondSize);
            this.dolomiteGen = new WorldGenMinable(BlockRegister.dolomite_ore.getDefaultState(), this.chunkProviderSettings.diamondSize);
            /*------------------------------*/
    ...
    protected void generateOres()
    {
        ...
        /*-----------Arifureta----------*/
        this.genStandardOre1(this.chunkProviderSettings.oxyteCount, this.oxyteGen, this.chunkProviderSettings.oxyteMinHeight, this.chunkProviderSettings.oxyteMaxHeight);
        this.genStandardOre1(this.chunkProviderSettings.bauxiteCount, this.bauxiteGen, this.chunkProviderSettings.bauxiteMinHeight, this.chunkProviderSettings.bauxiteMaxHeight);
        this.genStandardOre1(this.chunkProviderSettings.kobalteCount, this.kobalteGen, this.chunkProviderSettings.kobalteMinHeight, this.chunkProviderSettings.kobalteMaxHeight);
        this.genStandardOre1(this.chunkProviderSettings.dolomiteCount, this.dolomiteGen, this.chunkProviderSettings.dolomiteMinHeight, this.chunkProviderSettings.dolomiteMaxHeight);
