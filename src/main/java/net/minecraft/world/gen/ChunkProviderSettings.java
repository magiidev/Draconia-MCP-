...
public class ChunkProviderSettings
{
    ...
    /*------------Arifureta----------*/
    public final int oxyteSize;
    public final int oxyteCount;
    public final int oxyteMinHeight;
    public final int oxyteMaxHeight;

    public final int bauxiteSize;
    public final int bauxiteCount;
    public final int bauxiteMinHeight;
    public final int bauxiteMaxHeight;

    public final int kobalteSize;
    public final int kobalteCount;
    public final int kobalteMinHeight;
    public final int kobalteMaxHeight;

    public final int dolomiteSize;
    public final int dolomiteCount;
    public final int dolomiteMinHeight;
    public final int dolomiteMaxHeight;
    /*-------------------------------*/
    ...
    private ChunkProviderSettings(Factory settingsFactory)
    {
        ...
        /*-------------Arifureta------------*/
        this.oxyteSize = settingsFactory.oxyteSize;
        this.oxyteCount = settingsFactory.oxyteCount;
        this.oxyteMinHeight = settingsFactory.oxyteMinHeight;
        this.oxyteMaxHeight = settingsFactory.oxyteMaxHeight;

        this.bauxiteSize = settingsFactory.bauxiteSize;
        this.bauxiteCount = settingsFactory.bauxiteCount;
        this.bauxiteMinHeight = settingsFactory.bauxiteMinHeight;
        this.bauxiteMaxHeight = settingsFactory.bauxiteMaxHeight;

        this.kobalteSize = settingsFactory.kobalteSize;
        this.kobalteCount = settingsFactory.kobalteCount;
        this.kobalteMinHeight = settingsFactory.kobalteMinHeight;
        this.kobalteMaxHeight = settingsFactory.kobalteMaxHeight;

        this.dolomiteSize = settingsFactory.dolomiteSize;
        this.dolomiteCount = settingsFactory.dolomiteCount;
        this.dolomiteMinHeight = settingsFactory.dolomiteMinHeight;
        this.dolomiteMaxHeight = settingsFactory.dolomiteMaxHeight;
        /*----------------------------------*/
    ...
    public static class Factory
    {
        ...
        /*--------------Arifureta--------------*/
        public int oxyteSize = 4;
        public int oxyteCount = 1;
        public int oxyteMinHeight = 0;
        public int oxyteMaxHeight = 10;

        public int bauxiteSize = 5;
        public int bauxiteCount = 1;
        public int bauxiteMinHeight = 0;
        public int bauxiteMaxHeight = 12;

        public int kobalteSize = 6;
        public int kobalteCount = 1;
        public int kobalteMinHeight = 0;
        public int kobalteMaxHeight = 14;

        public int dolomiteSize = 7;
        public int dolomiteCount = 1;
        public int dolomiteMinHeight = 0;
        public int dolomiteMaxHeight = 15;
        /*-------------------------------------*/
        ...
        public void func_177863_a()
        {
            ...
            this.oxyteSize = 4;
            this.oxyteCount = 1;
            this.oxyteMinHeight = 0;
            this.oxyteMaxHeight = 10;

            this.bauxiteSize = 5;
            this.bauxiteCount = 1;
            this.bauxiteMinHeight = 0;
            this.bauxiteMaxHeight = 12;

            this.kobalteSize = 6;
            this.kobalteCount = 1;
            this.kobalteMinHeight = 0;
            this.kobalteMaxHeight = 14;

            this.dolomiteSize = 7;
            this.dolomiteCount = 1;
            this.dolomiteMinHeight = 0;
            this.dolomiteMaxHeight = 15;
            /*-------------------------------------*/
        ...
        public int hashCode()
        {
            ...
            /*--------------Arifureta--------------*/
            i = 31 * i + this.oxyteSize;
            i = 31 * i + this.oxyteCount;
            i = 31 * i + this.oxyteMinHeight;
            i = 31 * i + this.oxyteMaxHeight;

            i = 31 * i + this.bauxiteSize;
            i = 31 * i + this.bauxiteCount;
            i = 31 * i + this.bauxiteMinHeight;
            i = 31 * i + this.bauxiteMaxHeight;

            i = 31 * i + this.kobalteSize;
            i = 31 * i + this.kobalteCount;
            i = 31 * i + this.kobalteMinHeight;
            i = 31 * i + this.kobalteMaxHeight;

            i = 31 * i + this.dolomiteSize;
            i = 31 * i + this.dolomiteCount;
            i = 31 * i + this.dolomiteMinHeight;
            i = 31 * i + this.dolomiteMaxHeight;
            /*-------------------------------------*/
    ...
    public static class Serializer implements JsonDeserializer<Factory>, JsonSerializer<Factory>
    {
        public Factory deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
        {
            ...
            try
            {
                ...
                /*--------------Arifureta--------------*/
                chunkprovidersettings$factory.oxyteSize = JsonUtils.getInt(jsonobject, "oxyteSize", chunkprovidersettings$factory.oxyteSize);
                chunkprovidersettings$factory.oxyteCount = JsonUtils.getInt(jsonobject, "oxyteCount", chunkprovidersettings$factory.oxyteCount);
                chunkprovidersettings$factory.oxyteMinHeight = JsonUtils.getInt(jsonobject, "oxyteMinHeight", chunkprovidersettings$factory.oxyteMinHeight);
                chunkprovidersettings$factory.oxyteMaxHeight = JsonUtils.getInt(jsonobject, "oxyteMaxHeight", chunkprovidersettings$factory.oxyteMaxHeight);

                chunkprovidersettings$factory.bauxiteSize = JsonUtils.getInt(jsonobject, "bauxiteSize", chunkprovidersettings$factory.bauxiteSize);
                chunkprovidersettings$factory.bauxiteCount = JsonUtils.getInt(jsonobject, "bauxiteCount", chunkprovidersettings$factory.bauxiteCount);
                chunkprovidersettings$factory.bauxiteMinHeight = JsonUtils.getInt(jsonobject, "bauxiteMinHeight", chunkprovidersettings$factory.bauxiteMinHeight);
                chunkprovidersettings$factory.bauxiteMaxHeight = JsonUtils.getInt(jsonobject, "bauxiteMaxHeight", chunkprovidersettings$factory.bauxiteMaxHeight);

                chunkprovidersettings$factory.kobalteSize = JsonUtils.getInt(jsonobject, "kobalteSize", chunkprovidersettings$factory.kobalteSize);
                chunkprovidersettings$factory.kobalteCount = JsonUtils.getInt(jsonobject, "kobalteCount", chunkprovidersettings$factory.kobalteCount);
                chunkprovidersettings$factory.kobalteMinHeight = JsonUtils.getInt(jsonobject, "kobalteMinHeight", chunkprovidersettings$factory.kobalteMinHeight);
                chunkprovidersettings$factory.kobalteMaxHeight = JsonUtils.getInt(jsonobject, "kobalteMaxHeight", chunkprovidersettings$factory.kobalteMaxHeight);

                chunkprovidersettings$factory.dolomiteSize = JsonUtils.getInt(jsonobject, "dolomiteSize", chunkprovidersettings$factory.dolomiteSize);
                chunkprovidersettings$factory.dolomiteCount = JsonUtils.getInt(jsonobject, "dolomiteCount", chunkprovidersettings$factory.dolomiteCount);
                chunkprovidersettings$factory.dolomiteMinHeight = JsonUtils.getInt(jsonobject, "dolomiteMinHeight", chunkprovidersettings$factory.dolomiteMinHeight);
                chunkprovidersettings$factory.dolomiteMaxHeight = JsonUtils.getInt(jsonobject, "dolomiteMaxHeight", chunkprovidersettings$factory.dolomiteMaxHeight);
                /*-------------------------------------*/
        ...
        public JsonElement serialize(Factory p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_)
        {
            ...
            /*--------------Arifureta--------------*/
            jsonobject.addProperty("oxyteSize", (Number)Integer.valueOf(p_serialize_1_.oxyteSize));
            jsonobject.addProperty("oxyteCount", (Number)Integer.valueOf(p_serialize_1_.oxyteCount));
            jsonobject.addProperty("oxyteMinHeight", (Number)Integer.valueOf(p_serialize_1_.oxyteMinHeight));
            jsonobject.addProperty("oxyteMaxHeight", (Number)Integer.valueOf(p_serialize_1_.oxyteMaxHeight));

            jsonobject.addProperty("bauxiteSize", (Number)Integer.valueOf(p_serialize_1_.bauxiteSize));
            jsonobject.addProperty("bauxiteCount", (Number)Integer.valueOf(p_serialize_1_.bauxiteCount));
            jsonobject.addProperty("bauxiteMinHeight", (Number)Integer.valueOf(p_serialize_1_.bauxiteMinHeight));
            jsonobject.addProperty("bauxiteMaxHeight", (Number)Integer.valueOf(p_serialize_1_.bauxiteMaxHeight));

            jsonobject.addProperty("kobalteSize", (Number)Integer.valueOf(p_serialize_1_.kobalteSize));
            jsonobject.addProperty("kobalteCount", (Number)Integer.valueOf(p_serialize_1_.kobalteCount));
            jsonobject.addProperty("kobalteMinHeight", (Number)Integer.valueOf(p_serialize_1_.kobalteMinHeight));
            jsonobject.addProperty("kobalteMaxHeight", (Number)Integer.valueOf(p_serialize_1_.kobalteMaxHeight));

            jsonobject.addProperty("dolomiteSize", (Number)Integer.valueOf(p_serialize_1_.dolomiteSize));
            jsonobject.addProperty("dolomiteCount", (Number)Integer.valueOf(p_serialize_1_.dolomiteCount));
            jsonobject.addProperty("dolomiteMinHeight", (Number)Integer.valueOf(p_serialize_1_.dolomiteMinHeight));
            jsonobject.addProperty("dolomiteMaxHeight", (Number)Integer.valueOf(p_serialize_1_.dolomiteMaxHeight));
            /*-------------------------------------*/
