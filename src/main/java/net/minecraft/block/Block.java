...
public class Block
{
    ...
    /*-------------Arifureta---------*/
    //private ArifuretaTab displayOnArifuretaTab;
    /*-------------------------------*/
    ...
    /*-------------------------Arifureta------------------------------
    public void getSubBlocksArifureta(Item itemIn, ArifuretaTab tab, List<ItemStack> list)
    {
        list.add(new ItemStack(itemIn, 1, 0));
    }

    public ArifuretaTab getArifuretaTabToDisplayOn()
    {
        return this.displayOnArifuretaTab;
    }

    public Block setArifuretaTab(ArifuretaTab tab)
    {
        this.displayOnArifuretaTab = tab;
        return this;
    }
    ----------------------------------------------------------------*/
