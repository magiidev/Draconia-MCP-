...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof ArifuretaMainMenu)
        {
            this.updateMainMenu((ArifuretaMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(ArifuretaMainMenu arifuretaMainMenu)
    {
        try
        {
            String s = null;
            ...
            Reflector.setFieldValue(arifuretaMainMenu, Reflector.GuiMainMenu_splashText, s);
        }
