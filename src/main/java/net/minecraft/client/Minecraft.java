...
import com.aikodev.draconia.gui.ArifuretaMainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new ArifuretaMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new ArifuretaMainMenu());
        }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Constants.NAME + " " + Constants.VERSION);
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new ArifuretaMainMenu();
        }
        ...
        if (guiScreenIn instanceof ArifuretaMainMenu)
        {
