...
public class EnchantmentProtection extends Enchantment
{
    ...
    public EnchantmentProtection(int id, ResourceLocation resourceLocation, int rarity, int protectionType)
    {
        super(id, resourceLocation, rarity, EnumEnchantmentType.ARMOR);
