...
public abstract class Enchantment
{
    ...
    /*---------------Arifureta---------------*/
    public static final Enchantment smelt = new EnchantmentSmelt(63, new ResourceLocation(Constants.NAME.toLowerCase(), "smelt"), 2, EnumEnchantmentType.DIGGER);
    /*---------------------------------------*/
